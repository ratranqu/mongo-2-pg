...
# Usage: dump-database.sh <source-uri> <db-name> <output-dir> [parallel-collections]
set -euo pipefail

SOURCE_URI="${1:?Usage: dump-database.sh <source-uri> <db-name> <output-dir> [parallel-collections]}"
